...
# 使用一样的方法创建测试集和训练集
files_dir = 'Data/'
# nimpy_save = 'train_npy/'
nimpy_save = 'test_npy/'


if not os.path.exists(nimpy_save):
    os.makedirs(nimpy_save)
...
for i in range(len(list_sample_names)-1000):
    ...
    np.save(nimpy_save + list_sample_names[i] + '.npy', image_cts_np)




    print('第',i, '个数组文件已经成功创建！！！')
